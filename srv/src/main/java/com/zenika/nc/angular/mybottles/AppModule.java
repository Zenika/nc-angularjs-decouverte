...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("mybottles mybottles 7fc1e5ce-677a-41ef-a9a0-fbf2c346a1c9 1827215391032641476".getBytes(Charsets.UTF_8));
    }
    ...
    public BasicPrincipalAuthenticator basicPrincipalAuthenticator(
        ...
        return new StdBasicPrincipalAuthenticator(new StdUserService<StdUser>(
                ...
                // and better perf
                new FileBasedUserRepository<StdUser>(
